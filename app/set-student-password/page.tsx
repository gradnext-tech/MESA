...
export default function SetStudentPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(getApiUrl('api/auth/set-student-password'), {
        method: 'POST',
      ...
      <div className="w-full max-w-md p-8">
        <div className="rounded-xl shadow-2xl border p-8" style={{ backgroundColor: '#2A4A4A', borderColor: '#3A5A5A' }}>
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Create a secure password for your student account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Enter your email from Mentee Directory"
                  className="w-full pl-10 pr-4 py-3 rounded-lg border focus:ring-2 focus:border-transparent transition-all"
                  style={{ backgroundColor: '#1A3636', borderColor: '#3A5A5A', color: '#fff' }}
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!isLoading && !success) e.currentTarget.style.backgroundColor = '#16A34A';
              }}
              onMouseLeave={(e) => {
                if (!isLoading && !success) e.currentTarget.style.backgroundColor = '#22C55E';
              }}
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              ...
              <a href="login" className="font-medium hover:underline transition-colors" style={{ color: '#22C55E' }}>
                Sign In
              </a>
            </p>
          </div>
